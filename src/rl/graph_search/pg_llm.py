...
class PolicyGradientLLM(LFramework):
    def __init__(self, args, kg, pn):
        super(PolicyGradientLLM, self).__init__(args, kg, pn)
    ...
    def loss(self, mini_batch, eid2entity, rid2relation):
        ...
        output = self.rollout(e1, r, e2,
                              num_steps=self.num_rollout_steps,
                              eid2entity=eid2entity,
    ...
    def rollout(self, e_s, q, e_t, num_steps, eid2entity, rid2relation, visualize_action_probs=False):
        """
        ...
        :param eid2entity: Entity id to name mapping.
        :param rid2relation: Relation id to name mapping.
